...
if(SDL2_FOUND)
  ...
  if(NOT TARGET SDL2::Core)
    ...
    set_target_properties(SDL2::Core PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                                ${SDL2_INCLUDE_DIR})
    ...
    if(SDL2_LIBRARY_RELEASE)
      ...
      set_target_properties(SDL2::Core PROPERTIES IMPORTED_LOCATION_RELEASE
                                                  ${SDL2_LIBRARY_RELEASE})
    endif()
    ...
    if(SDL2_LIBRARY_DEBUG)
      ...
      set_target_properties(SDL2::Core PROPERTIES IMPORTED_LOCATION_DEBUG
                                                  ${SDL2_LIBRARY_DEBUG})
    endif()
    ...
    if(NOT SDL2_LIBRARY_RELEASE AND NOT SDL2_LIBRARY_DEBUG)
      set_property(
        TARGET SDL2::Core
        APPEND
        PROPERTY IMPORTED_LOCATION ${SDL2_LIBRARY})
    endif()
  endif()
  ...
  if(NOT TARGET SDL2::SDL2)
    ...
    set_target_properties(
      SDL2::SDL2 PROPERTIES INTERFACE_LINK_LIBRARIES SDL2::Core
